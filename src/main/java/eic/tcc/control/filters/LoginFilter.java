package eic.tcc.control.filters;
...
import com.castaware.nocturne.mvc.login.SessionBean;
...
public class LoginFilter implements Filter 
{
	...
	public void init(FilterConfig config) throws ServletException 
	{
		...
		Collection<Module> scaModules = springContext.getBeansOfType(Module.class).values();		
		
		for (Module scaModule : scaModules) 
		{
